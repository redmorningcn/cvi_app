...
#define  SETP_PANEL_SETLOCO_6             4       /* control type: command, callback function: SetLocoCallBack */
#define  SETP_PANEL_DECORATION_16         5       /* control type: deco, callback function: (none) */
#define  SETP_PANEL_SETLOCO_5             6       /* control type: command, callback function: SetLocoCallBack */
