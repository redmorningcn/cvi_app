...
#define  MAINPANEL_OPEN_REC               3       /* control type: command, callback function: OpenOilRecordPandelCallback */
...
int  CVICALLBACK OpenOilRecordPandelCallback(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
